  ...
  <aside class="main-sidebar" style="background-color: #6FB98F; elevation: 4;">
    <!-- Brand Logo -->
    <a href="{{ route('dashboard') }}" class="brand-link">
      <img src="{{asset('icon-inventaris.png')}}" alt="AdminLTE Logo" class="brand-image custom-logo" style="opacity: .8">
      <span class="brand-text font-weight-bold" style="color: white;">{{config('app.name')}}</span>
    </a>
